...
import { GithubBtn, OtpBtn, SubmitBtn } from "@/components/Buttons";
import Logo from "@/components/Logo";
import { BookLock, Check, Lock, Mail, X } from "lucide-react";
import Image from "next/image";
import React, { useState } from "react";
import signupSchema from "@/schemas/signupSchema";
import { account, database, ID } from "@/app/(root)/appwrite";
...
const Page = () => {
  ...
  return (
    <main className="lg:px-48 text-[#6b6a6a] lg:py-2 p-6 overflow-clip">
      <Logo />
      <div className="flex lg:flex-row  flex-col-reverse justify-between items-center">
        ...
        <div className="bg-white rounded-2xl text-center p-7 lg:mt-1 mt-6  shadow-lg flex flex-col justify-center items-center">
          <h1 className="text-3xl text-[#3F3B3B] font-black ">
            Join Linkhub for Free
          </h1>
          <h3 className="text-xs font-extralight ">Sign up to Smartlink 🔗</h3>
          <GithubBtn />
          <p className="">OR</p>
